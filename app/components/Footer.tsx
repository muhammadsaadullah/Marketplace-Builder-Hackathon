...
export default function Footer(){
    ...
    return(
        <div className={`flex flex-col ${ isHomePage? "relative z-0 pt-0" : "pt-[110px] overflow-hidden" } px-[200px] justify-center items-center h-full w-screen bg-black gap-10  `}>
